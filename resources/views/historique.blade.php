...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
      ...
      class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500">
      ...
      <div>
      <button
      class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded-lg focus:outline-none transition-colors duration-200">
    ...
    @elseif ($trajet->status == 'refuser')
      <span
      class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-red-100 text-red-800">refuse</span>
  @else
    <span
...
@endif
      ...
      @if ($trajet->status == 'pending')
      <a href="{{ Route('refuser', ['id' => $trajet->id]) }}"
      class="text-yellow-600 hover:text-yellow-900 focus:outline-none">refuser</a>
  @endif
  ...
  @endif
    ...
    <div class="flex items-center justify-between mt-6">
      ...
      Affichage de <span class="font-medium">1</span> à <span class="font-medium">3</span> sur <span
      class="font-medium">3</span> trajets
      </span>
      </div>
